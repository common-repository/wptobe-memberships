...
return array(
    ...
    'image_width'      => 314,       // width of captcha image in pixels
    'image_height'     => 65,       // height of captcha image in pixels
    'code_length'      => 4,         // # of characters for captcha code
    'image_bg_color'   => '#fff',//'#ddd', // hex color for image background
    'text_color'       => '#333',//'#707070', // hex color for captcha text
    'line_color'       => '#707070', // hex color for lines over text
    'noise_color'      => '#707070', // color of random noise to draw under text
    'num_lines'        => 0,         // # of lines to draw over text
    'noise_level'      => 2,         // how much random noise to add (0-10)
    'perturbation'     => 0,//0.1,       // distoration level

    'use_random_spaces'   => true,
    'use_random_baseline' => false,//true,
    'use_text_angles'     => false,//true,
